    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-emerald-50 via-white to-carbon-50 dark:from-surface-950 dark:via-surface-900 dark:to-surface-950 p-4">
      ...
      >
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold gradient-text">Join CarbonWise</h1>
          <p className="text-surface-500 dark:text-surface-400 mt-2">
        ...
        <div className="glass-card p-8">
          <form onSubmit={handleSubmit} noValidate aria-label="Signup form">
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="relative">
                  <User className="absolute left-3.5 top-1/2 -translate-y-1/2 w-5 h-5 text-surface-400" aria-hidden="true" />
                  <input
                    id="signup-name"
                    type="text"
                    value={name}
          ...
          <p className="text-center text-sm text-surface-500 mt-6">
            ...
            <Link to="/login" className="text-emerald-600 hover:text-emerald-700 font-medium dark:text-emerald-400">
              Sign in
            </Link>
          </p>
        </div>
